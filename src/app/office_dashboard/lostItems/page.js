...
export default function LostItems() {
  ...
  const displayedItems = lostItems.slice(startIndex, endIndex);
  ...
  return (
    <>
          ...
          <Box sx={{ width: "100%", marginBottom: "3rem" }}>
            <Grid container display="flex" justifyContent="space-between">
              ...
              >
                <Button
                  component={Link}
                  href="/office_dashboard/lostItems/requests"
                  color="primary"
                  variant="solid"
                ...
                >
                  <ModalDialog>
                    ...
                    <Stack spacing={2}>
                      ...
                      <FormControl>
                        <Input required placeholder="Item Lost" />
                      </FormControl>
                      <FormControl>
                        <LocalizationProvider dateAdapter={AdapterDayjs}>
                          <DemoContainer components={["DateTimeField"]}>
                            <DemoItem>
                              <DateTimePicker label="Date and Time Lost" />
                            </DemoItem>
                          </DemoContainer>
                        </LocalizationProvider>
                      </FormControl>
                      <FormControl>
                        <Input required placeholder="Owner" />
                      </FormControl>
                      <FormControl>
                        <Button
                          component="label"
              ...
              >
                <Card sx={{ maxWidth: 345 }} elevation={3}>
                  ...
                  <CardActions>
                    <Button
                      component="a"
                      href={`/office_dashboard/lostItems/${item.id}`}
                      size="small"
                      variant="plain"
                    >
                      More Details
      ...
      <Pagination
        count={Math.ceil(lostItems.length / itemsPerPage)}
        page={page}
